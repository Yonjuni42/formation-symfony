...
class ComputerControllerTest extends WebTestCase
{
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'parkbundle_computer[name]'  => 'Test',
            'parkbundle_computer[ip]'  => '192.test.1',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'parkbundle_computer[name]'  => 'Foo',
            'parkbundle_computer[ip]'  => '192.foo.1',
            'parkbundle_computer[enabled]'  => true,
            // ... other fields to fill
        ));
        $form['parkbundle_computer[person]']->select('28');
